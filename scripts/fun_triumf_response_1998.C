//
#ifndef __fun_triumf_response_1998__
#define __fun_triumf_response_1998__
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
double fun_triumf_response_1998(double* Energy, double* P) {
  ...
  //  printf(">>> fun_triumf_response_1998: E, Er : %12.5e %12.5e %12.5e\n",E,Er,y);
//-----------------------------------------------------------------------------
// E0 parameterization
//-----------------------------------------------------------------------------
